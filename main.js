...
const TECH_SERVICES = [
  { cat: "SPACE & INTERIORS", icon: ICONS.hardware, title: "Architectural Design", desc: "Strategic space planning and interior design solutions for Cafes, Stores, Restaurants, Offices, and Homes.", img: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800" },
  { cat: "DESIGN & BRANDING", icon: ICONS.brand, title: "Brand Identity", desc: "Crafting unique brand identities, logos, packaging, and business collaterals like cards and letterheads.", img: "https://images.unsplash.com/photo-1626785774573-4b799315345d?auto=format&fit=crop&q=80&w=800" },
  { cat: "USER EXPERIENCE", icon: ICONS.led, title: "UI/UX Design", desc: "E-Commerce websites, product shoots, landing pages, and content development designed for conversion.", img: "https://images.unsplash.com/photo-1586717791821-3f44a563eb4c?auto=format&fit=crop&q=80&w=800" },
  { cat: "VISUAL COMMS", icon: ICONS.security, title: "Graphic Design", desc: "Posters, brand creatives, icons, and visual layouts that communicate your message effectively.", img: "https://images.unsplash.com/photo-1572044162444-ad60f128bdea?auto=format&fit=crop&q=80&w=800" },
  { cat: "GROWTH", icon: ICONS.isp, title: "Digital Marketing", desc: "Social media management, photoshoot, Facebook/Insta ads, and Google Search & Display advertising.", img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=800" },
  { cat: "INFRASTRUCTURE", icon: ICONS.network, title: "Networking & Security", desc: "Enterprise-grade IT infrastructure, cyber security, and surveillance systems for total business protection.", img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc48?auto=format&fit=crop&q=80&w=800" }
];
