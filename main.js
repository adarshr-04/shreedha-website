...
const TECH_SERVICES = [
  { cat: "DIGITAL DEFENSE", icon: ICONS.security, title: "Cyber Security", desc: "Enterprise-grade protection strategies to safeguard your critical data and network assets.", img: "https://shreedha.netlify.app/assets/cyber_security_1766593195888.png" },
  { cat: "CONNECTIVITY", icon: ICONS.network, title: "Networking / Security", desc: "High-performance network design with integrated security for seamless business continuity.", img: "https://shreedha.netlify.app/assets/networking_security_1766593214565.png" },
  { cat: "RETAIL TECH", icon: ICONS.billing, title: "Billing Solutions", desc: "Intelligent POS hardware and software ecosystems tailored for modern commerce.", img: "https://shreedha.netlify.app/assets/billing_solutions_pos_2_1766593248951.png" },
  { cat: "COMPUTING", icon: ICONS.hardware, title: "Computer Hardware", desc: "Quality accessories and high-performance components for every business scale.", img: "https://shreedha.netlify.app/assets/computer_hardware_2_1766593269063.png" },
  { cat: "DIGITAL SIGNAGE", icon: ICONS.led, title: "LED Sign Boards", desc: "Modern digital signage that captures attention and elevates your brand's physical presence.", img: "https://shreedha.netlify.app/assets/led_sign_boards_2_1766593284513.png" },
  { cat: "COLLABORATION", icon: ICONS.av, title: "AV Solutions", desc: "State-of-the-art meeting room setups optimized for global collaboration.", img: "https://shreedha.netlify.app/assets/av_solutions_3_1766593310758.png" },
  { cat: "ENVIRONMENTAL", icon: ICONS.ac, title: "Air Conditioners", desc: "Cooling solutions designed specifically for critical data rooms and corporate offices.", img: "https://shreedha.netlify.app/assets/air_conditioners_3_1766593325766.png" },
  { cat: "INTERNET", icon: ICONS.isp, title: "Internet Service (ISP)", desc: "High-speed, dedicated fiber connectivity ensuring your business is always online.", img: "https://shreedha.netlify.app/assets/isp_internet_5_1766593524613.png" },
  { cat: "SURVEILLANCE", icon: ICONS.cctv, title: "CCTV & Surveillance", desc: "Advanced video monitoring and recording systems for comprehensive site security.", img: "https://shreedha.netlify.app/assets/uploaded_image_3_1766601257305.png" }
];

const COMPLIANCE_SERVICES = [
  { cat: "LEGAL", icon: ICONS.compliance, title: "Statutory Compliance", desc: "End-to-end management of industrial legal obligations and regulatory standards.", img: "https://shreedha.netlify.app/assets/statutory_compliance_2_1766593561121.png" },
  { cat: "ESTABLISHMENT", icon: ICONS.compliance, title: "Establishment Compliance", desc: "Adherence support for commercial offices, shops, and establishment regulations.", img: "https://shreedha.netlify.app/assets/establishment_compliance_2_1766593576232.png" },
  { cat: "FINANCE", icon: ICONS.audit, title: "Audit and Taxation", desc: "Professional auditing and strategic tax consultations to optimize your business finances.", img: "https://shreedha.netlify.app/assets/uploaded_image_4_1766601257305.png" },
  { cat: "TAXATION", icon: ICONS.tax, title: "GST Services", desc: "Seamless registration and periodic filing management for effortless tax compliance.", img: "https://shreedha.netlify.app/assets/uploaded_image_0_1766601257305.png" },
  { cat: "HUMAN RESOURCES", icon: ICONS.payroll, title: "Payroll Services", desc: "Accurate payroll processing and management of employee-related benefits.", img: "https://shreedha.netlify.app/assets/uploaded_image_1_1766601257305.png" },
  { cat: "STRATEGY", icon: ICONS.brand, title: "Branding Solutions", desc: "Creative brand strategy and identity design to help your business lead the market.", img: "https://shreedha.netlify.app/assets/uploaded_image_1766601354768.jpg" }
];
